...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        dinner.setRestaurantname("Golden Duck");
        dinner.setDescription("Nothing");
        dinner.setPhonenumber("0912345");
        dinner.setRoomdescription("Room Description");
        dinner.setPricedescription("Nothing");
        dinner.setPrice(Arrays.asList(new Price(30, 15, 30)));
        dinner.setAddress("Yangon");
        dinner.setRoomfees(Arrays.asList(new RoomFees(10, 10, 3, 150000)));

        mongoTemplate.insert(dinner);
...
//
//
//  Dinner dinner = new Dinner("Wai Yan","0987654","Yangon","Yangon","Yangon",Arrays.asList(new RoomFees(1,1,1,1)),"Yangon",Arrays.asList(new Price(1,1,1)));
//  Collection<Dinner> dinnerc=Arrays.asList(dinner);
// this.mongoTemplate.insertAll(dinnerc);
